...
public:
    ...
    void initializeRestaurants() {
        ...
        Restaurant* restaurant4 = new Restaurant("Dhakad", "Delhi");
        restaurant4->addMenuItem(MenuItem("P1", "Maggie", 30));
        restaurant4->addMenuItem(MenuItem("P2", "Samosa", 15));
        restaurant4->addMenuItem(MenuItem("P3", "Filter Coffee", 30));
